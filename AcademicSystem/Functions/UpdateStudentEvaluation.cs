...
public class UpdateStudentEvaluation : Connection
{
                            ...
                            while (loop2)
                            {
                                ...
                                while (reader3.Read())
                                {
                                    if (studenGroupID == (int)reader3["GroupID"])
                                    {
                                        ...
                                        i++;
                                        string querySGrade = string.Format(
                                            "SELECT * FROM `subject evaluation` WHERE `StudentID` = '{0}' AND `TeachingSubjectID` = '{1}' ",
                                            (int)reader3["StudentID"], list[selection1Int - 1]);
                                        var cmdSGrade = new MySqlCommand(querySGrade, Conn());
                                        var readerSGrade = cmdSGrade.ExecuteReader();
                                        while (readerSGrade.Read())
                                        {
                                            Console.Write(" " + (int)readerSGrade["Grade"]);
                                        }
                                        cmdSGrade.Connection.Close();
                                        Console.WriteLine();
                                    }
                                }
                                    ...
                                    if (selection2Int <= Convert.ToInt32(reader4) && selection2Int > 0)
                                    {
                                        ...
                                        if (studentsHasEvaluation == true)
                                        {
                                            ...
                                            while (loop3 == true)
                                            {
                                                ...
                                                Console.WriteLine("Please type in the students updated evaluation:");
                                                ...
                                                if (grade != String.Empty)
                                                {
                                                    ...
                                                    {
                                                        loop3 = false;
                                                        string queryEvaluation = string.Format("update `subject evaluation` set `Grade` = '{0}' where `TeachingSubjectID` = '{1}' AND `StudentID` =  '{2}'", gradeInt,list[selection1Int-1],list2[selection2Int-1]);
                                        ...
                                        {
                                            Console.Clear();
                                            Console.WriteLine("This student has has not been evaluated.");
                                            Console.ReadKey();
                                            Console.Clear();
                                        }
